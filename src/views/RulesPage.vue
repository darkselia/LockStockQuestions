...
const ruleBlocks = [
  ...
  },
  {
    ...
    items: [
      'Стартовый банк игрока — 20 000 фишек.',
  ...
  },
  {
    ...
    items: [
      ...
      'Пропорция от шоу: 800 / 20 000 = 0,04',
      'Стартовая обязательная ставка: 500 * 0,04 = 20 фишек. ',
      'Увеличение обязательной ставки в каждом раунде: +20 фишек. ',
    ],
  },
];
